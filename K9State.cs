namespace AdvancedK9
{
    ...
    internal enum K9Command { SpawnDismiss, Follow, Heel, Sit, LieDown, Stay, Recall, WhistleRecall, HandSignal, Fetch, SearchArea, SearchVehicle, SearchNarcotics, SearchExplosives, SearchWeapons, CollectScent, Track, Apprehend, DoorPop, Release, Guard, Bark, EnterVehicle, ExitVehicle, Pet, Feed, Drink, Bathroom, Rest, Inspect, FirstAid, VeterinaryCare, Restock, ToggleLeash, ToggleCamera, Training, TrainNarcotics, TrainExplosives, TrainWeapons }
}
