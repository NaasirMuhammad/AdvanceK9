...
namespace AdvancedK9
{
    ...
    internal static class CommandRegistry
    {
        ...
        public static readonly IReadOnlyList<CommandDefinition> All=new[]{
            ...
            D(K9Command.CollectScent,"Collect Scent Article",true,"collect scent article","bag the scent","take scent sample","collect scent","collect scent from vehicle","collect vehicle scent","sample the vehicle scent"),
            D(K9Command.Track,"Track",true,"start tracking","pick up the scent","follow the scent","find the trail","track the suspect","locate them","find him","find her","find them","track scent from vehicle","track from vehicle","track vehicle scent","track the child","track scent","track"),
            ...
            D(K9Command.SaveContainmentPosition,"Save Containment Position",true,"save containment position","mark containment position","save this perimeter point"),
            D(K9Command.SendContainmentPosition,"Send to Containment Position",true,"send to containment position","deploy to saved position","take containment position"),
            D(K9Command.NextContainmentPosition,"Next Containment Position",true,"next containment position","move to next perimeter point","cycle containment position"),
            D(K9Command.ClearContainmentPosition,"Clear Containment Position",true,"clear containment position","remove saved perimeter point","delete containment position"),
