        ...
        private async System.Threading.Tasks.Task TranscribeAsync(byte[] wave)
        {
            ...
            try
            {
                ...
                using (var request = new HttpRequestMessage(HttpMethod.Post, _endpoint))
                {
                    ...
                    form.Add(new StringContent("Police K9 handler command audio. The dog is named " + _dogName + ". Preserve the wake word and command exactly. K9 may be spoken as K-9, K nine, kay nine, canine, or " + _dogName + ". Likely commands include deploy, dismiss, sit, down, stay, follow, heel, recall, vehicle search, area search, narcotics search, drug search, bomb search, explosives search, weapons search, gun search, track, apprehend, attack, engage, release, guard, bark, fetch, enter vehicle, exit vehicle, leash, camera, inspect, first aid, feed, treat, give water, drink, hydrate, pet, praise, core training, narcotics training, explosives training, weapons training, academy, and certification."), "prompt");
